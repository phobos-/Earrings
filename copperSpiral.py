...
def FNC_spiral (cntr, # (x,y)
    ...
    for j in range(turns):
        ...
        for i in range(int(segs)):
            ...
            STR_data += FNC_string (lineType, #type of line
...
if __name__ == '__main__':
	...
	for i in [("fcu", "seg"), ("bcu", "seg"), ("fma", "lne"), ("bma", "lne")]:

		Center = [148.5,94.8] # x/y coordinates of the centre of the pcb sheet
		Radius = 0.0 # start radius in mm
		Sides = 36.0
